...
After you see *Hello World!* in the browser, type ``localhost:5000/foobar`` into the address bar and press Enter or Return.

You’re ready now to move on to `Flask, Part 2 <flask2.html>`_.
